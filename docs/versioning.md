...
| Repository/software package | 0.2.0, proposed tag v0.2.0 | First standalone repository release candidate |
| Repository metadata schema | 1.0.0 | Validation/derivation metadata contract |
...
Published tags are immutable. No tag exists for this release candidate. Citation
